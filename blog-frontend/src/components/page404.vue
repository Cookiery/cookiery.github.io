<template>
  <div class="content">
    <div class="page-404">
        ...
        <p class="info">
            you've reached the edge of universe.The Page you've requested , can't befound. Don't Worry , you can 
            return to previous page.
        </p>
        <button class="go-home btn">GO HOME</button>
    </div>
    <div class="astronaut">
        <img src="../assets/404-astronaut.png" class="astronaut-img" alt="">
    </div>
  </div>
</template>
...
.content {
  ...
  background: url(../assets/404-bg.png);
